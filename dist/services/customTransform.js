...
exports.hasCustomTransform = hasCustomTransform;
exports.removeCustomTransform = removeCustomTransform;
exports.saveCustomTransform = saveCustomTransform;
exports.executeCustomTransform = executeCustomTransform;
...
const customTransformPath = path_1.default.join(__dirname, "../../saves/customTransform.py");
/**
 ...
 * - false otherwise
 */
function hasCustomTransform() {
    return fs_1.default.existsSync(customTransformPath);
}
/**
 ...
 */
function removeCustomTransform() {
    return __awaiter(this, void 0, void 0, function* () {
        if (fs_1.default.existsSync(customTransformPath)) {
            fs_1.default.unlinkSync(customTransformPath);
        }
    });
}
/**
 ...
 */
function saveCustomTransform(fileBuffer) {
    return __awaiter(this, void 0, void 0, function* () {
        fs_1.default.writeFileSync(customTransformPath, fileBuffer);
    });
}
/**
 ...
 */
function executeCustomTransform(input) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!fs_1.default.existsSync(customTransformPath)) {
